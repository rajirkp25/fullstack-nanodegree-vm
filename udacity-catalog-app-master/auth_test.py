...
GOOGLE_CLIENT_ID = '371989888731-eed3srr3t5qa7krqc01ode3fvt91ghj9.apps.googleusercontent.com'  # os.environ.get("GOOGLE_CLIENT_ID")
GOOGLE_CLIENT_SECRET = 'K-7FZDmsHfnvyCB8WuwmvG6l'  # os.environ.get("GOOGLE_CLIENT_SECRET")
