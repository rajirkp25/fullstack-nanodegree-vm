...
user1 = User(name="Raji Rama", email="rajir.home@gmail.com",
             picture='https://cdn.theatlantic.com/assets/media/img/mt/2017/10/Pict1_Ursinia_calendulifolia/lead_720_405.jpg?mod=1533691909')
session.add(user1)
...
cat2 = Category(name="Children's Book Series", description="A children's book series is a set of fiction books, with a connected story line, written for children.")

session.add(cat2)

cat3 = Category(name="Meditation", description="Meditation is a practice where an individual uses a technique – such as mindfulness, or focusing their mind on a particular object, thought or activity – to train attention and awareness, and achieve a mentally clear and emotionally calm and stable state")
...
cat5 = Category(name="Books for Wisdom", description=" These books will make you smarter. They offer wisdom that has stood the test of time, provide ideas for managing the complexities and challenges of life, and foster a greater understanding of our world.")

session.add(cat5)

cat6 = Category(name="Ancient History", description="Throughout the years, archaeologists have come across incredible discoveries. Some of these discoveries are ancient manuscripts which have been found to portray history from a different point of view. A controversial point of view.")

session.add(cat6)

cat7 = Category(name="Biography", description="A biography (from the Greek words bios meaning life, and graphos meaning write) is a non-fictional account of a person's life. Biographies are written by an author who is not the subject/focus of the book.")

session.add(cat7)

cat8 = Category(name="Spirituality", description="Spirituality may refer to almost any kind of meaningful activity, personal growth, or blissful experience.Traditionally, spirituality refers to a process of re-formation of the personality but there is no precise definition of spirituality.")
...
cat10 = Category(name="Philosophy", description="Philosophy is the study of general and fundamental questions about existence, knowledge, values, reason, mind, and language. Such questions are often posed as problems to be studied or resolved. The term was probably coined by Pythagoras")
