# #!/usr/bin/env python3
# database initialization for the app
...
user1 = User(
    name="Raji Rama",
    email="raji.rkphamsan@gmail.com",
    user_type="admin",
...
user2 = User(
    name="Veda Ayala",
    email="veda.ayala@gmail.com",
    avatar='https://cdn.theatlantic.com/assets/media/img/mt/2017/10/Pict1_Ursinia_calendulifolia/lead_720_405.jpg?mod=1533691909')
session.add(user2)

user3 = User(
    name="Koutilya Vish",
    email="koutilya.vish@gmail.com",
    avatar='https://cdn.theatlantic.com/assets/media/img/mt/2017/10/Pict1_Ursinia_calendulifolia/lead_720_405.jpg?mod=1533691909')
session.add(user3)
...
cat2 = Category(
    ...
    description="A children's book series is a set of fiction books, with a connected story line, written for children.",
    tile="bg-primary",
    user=user1)
...
cat5 = Category(
    name="Books for Wisdom",
    description=" These books will make you smarter. They offer wisdom that has stood the test of time, provide ideas for managing the complexities and challenges of life, and foster a greater understanding of our world.",
    tile="bg-warning",
    user=user1)
...
cat6 = Category(
    ...
    description="Throughout the years, archaeologists have come across incredible discoveries. Some of these discoveries are ancient manuscripts which have been found to portray history from a different point of view. A controversial point of view.",
    tile="bg-primary",
    user=user1)
...
cat8 = Category(
    name="Spirituality",
    description="Spirituality may refer to almost any kind of meaningful activity, personal growth, or blissful experience.Traditionally, spirituality refers to a process of re-formation of the personality but there is no precise definition of spirituality.",
...
cat10 = Category(
    name="Philosophy",
    description="Philosophy is the study of general and fundamental questions about existence, knowledge, values, reason, mind, and language. Such questions are often posed as problems to be studied or resolved. The term was probably coined by Pythagoras",
    tile=random.choice(tile_color_list),
    user=user1)
...
catItem2 = CategoryItem(
    ...
    description="The alien invasion or space invasion is a common feature in science fiction stories and film, in which extraterrestrials invade the Earth either to exterminate and supplant human life, enslave it under an intense state, harvest people for food, steal the planet's resources, or destroy the planet altogether. ",
    price="$7.50",
...
catItem4 = CategoryItem(
    name="Ender's Game",
    description="Young Andrew Ender Wiggin, bred to be a genius, is drafted to Battle School where he trains to lead the century-long fight against the alien Buggers.",
    price="$19.50",
...
catItem6 = CategoryItem(
    name="The Secrets of Droon",
    description="The Secrets of Droon is a fantasy book series by Tony Abbott aimed at elementary school-age children. The first book, The Hidden Stairs and the Magic Carpet, was published on June 1, 1999. On October 1, 2010, the final book of the series.",
    price="$7.50",
    author="Tony Abbott",
    category=cat2)
...
catItem7 = CategoryItem(
    name="Sam Hawkins, Pirate Detective",
    description="TSam Hawkins, Pirate Detective is a series of comedy children's books by Ian Billings. The first book, Sam Hawkins Pirate Detective and the Case of the Cutglass Cutlass was published by Macmillan Publishers in 2003. The sequel, Sam Hawkins Pirate Detective and the Pointy Head Lighthouse was published in 2004.",
    price="$12.50",
    author="Ian Billings",
    category=cat2)
...
catItem9 = CategoryItem(
    name="Nancy Drew Mystery Stories",
...
catItem12 = CategoryItem(
    name="A Better Human",
    description="Of all the religions, creeds, and self-help manifestos the world has produced, most concentrate on how to achieve salvation in aspects other than the here-and-now, with our lives merely transitory testing grounds for a higher realm or our actions guided so that we maximize life in a state of 'enlightened hedonism,' consuming rapaciously but really achieving not much at all.",
    price="$2.50",
    author="George J. Bradley",
    category=cat3,
    best_seller_rank=0)

session.add(catItem12)

catItem13 = CategoryItem(
    name="The Essence of Self-Realization",
    description="Yogananda was one of the most significant spiritual teachers of the 20th century. Since his classic, Autobiography of a Yogi, was first published in 1946, its popularity has increased steadily throughout the world. The Essence of Self-Realization is filled with lessons and stories that Yogananda shared only with his closest disciples, this volume offers one of the most insightful and engaging glimpses into the life and lessons of a great sage. Much of the material presented here is not available anywhere else.",
    price="$9.50",
...
catItem15 = CategoryItem(
    name="Chakras: The Mystical Rainbow in You",
    description="Just like the body has nerve plexuses which bundle together hundreds of nerves in order to distribute them to various regions of the body, so too does the body have energy plexuses, also known as chakras, which allow one to “step down” energy from the higher realms into the physical body.There are seven main chakras in the body situated along the spine, as well as several “outside” the body which connect a person to the earth and to higher dimensional planes, including universal awareness. ",
    price="$20.50",
    author="Basmati",
    category=cat3,
    best_seller_rank=0)
...
catItem16 = CategoryItem(
    name="Mythology: Timeless Tales of Gods and Heroes",
    description="Edith Hamilton's mythology succeeds like no other book in bringing to life for the modern reader the Greek, Roman and Norse myths that are the keystone of Western culture-the stories of gods and heroes that have inspired human creativity from antiquity to the present. ",
    price="$20.50",
